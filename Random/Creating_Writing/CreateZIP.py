...
# someDirectory = "C:\Users\wyatt\Desktop\Wyatt\Python_Code\Git\Fun_With_Python\Random/Creating_Writing"
# for files in os.listdir(someDirectory):
#     if files.endswith(".zip"):
#         print files.title().lower()